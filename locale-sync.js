...
const LOCALES = 'en_US nl_NL es_ES'.split(' ');
const LANGUAGES = LOCALES.map(e => e.split('_')[0]);//, 'de', 'it'];
const PREFIXES = LOCALES.reduce((prefixes, locale) => {
  prefixes[locale.split('_')[0]] = locale;
  return prefixes;
}, {});
